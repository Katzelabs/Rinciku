-- §13 storage policies for the `expense-attachments` and `income-attachments`
-- buckets. The buckets themselves are created by supabase/seed.sql (declarative
-- schemas handle DDL only). Object paths are namespaced by `<auth.uid()>/...`.
