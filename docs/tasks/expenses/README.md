...
Core transaction logging. Manual entry first; image-based AI extraction lands later under `ai-chat/` but the attachment record + storage upload is independent and lives here.
