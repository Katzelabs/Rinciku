...
// Port of the web AuthProvider, swapping in the AsyncStorage-backed mobile
// Supabase client. Tracks the session (getSession + onAuthStateChange) and the
// user's profile row; `loading` stays true until both the session and (when
// signed in) the matching profile have resolved.
