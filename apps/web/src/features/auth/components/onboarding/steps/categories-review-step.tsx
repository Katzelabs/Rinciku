...
import {
  ...
  MAX_TIERS,
} from '@/features/categories/lib/limits';
import {
  groupByTier,
  type Tier,
  type TierGroup,
...
// Spending tiers/categories review, reused inside the onboarding wizard. Mirrors
// the spending slice of the Categories page (same refetch + dialog machinery),
// trimmed of the page header, tabs, and income panel. Tiers/categories already
// exist (seeded at signup) — edits here persist immediately via the shared
// CategoryForm/TierForm.
export function CategoriesReviewStep() {
